...
class LessProductOrderedBasedOnBranchesChart extends CustomChartWidget
{
    ...
    public $branches;
    protected static ?string $heading = 'أقل المنتجات المطلوبة';
    protected static ?string $maxHeight = '300px';
    protected static string $view = 'vendor.filament.widgets.less-product-ordered-based-on-branches';
    ...
    protected function getData(): array
    {
        ...
        $query = DB::table('orders_details')
            ...
            ->orderBy(DB::raw('sum(orders_details.available_quantity)'), 'asc')
