...
namespace Modules\HR\Http\Controllers\Auth;
...
class AuthenticatedSessionController extends Controller
{
    ...
    {
        if ($lang == '') {
            $lang = \Modules\HR\Entities\Utility::getValByName('default_language');
        }
        \App::setLocale($lang);

        return view('hr::auth.login', compact('lang'));
