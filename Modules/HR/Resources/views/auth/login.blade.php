...
@section('language-bar')
    <li class="nav-item">
        <select name="language" id="language" class="lang-dropdown btn btn-primary my-1 me-2"
            ...
            {{-- @foreach (\Modules\HR\Entities\Utility::languages() as $language)
                <option @if ($lang == $language) selected @endif value="{{ route('login', $language) }}">
                    {{ Str::upper($language) }}</option>
            @endforeach --}}
            @foreach (Modules\HR\Entities\Utility::languages() as $code => $language)
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate=""
                        ...
                        <div>
                            ...
                            @if (\Modules\HR\Entities\Utility::getValByName('disable_signup_button') == 'on')
